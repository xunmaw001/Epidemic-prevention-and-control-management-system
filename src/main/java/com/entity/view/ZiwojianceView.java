...
public class ZiwojianceView extends ZiwojianceEntity implements Serializable {
	...
	public ZiwojianceView() {

	}

	public ZiwojianceView(ZiwojianceEntity ziwojianceEntity) {
		try {
			BeanUtils.copyProperties(this, ziwojianceEntity);
